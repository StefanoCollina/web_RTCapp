...
function updatePreview() {
    ...
    blocks.forEach((block, i) => {
        const text = block.querySelector(".question-text").value.trim() || "(domanda vuota)";
...
function attachInputListener(block) {
...
sendQuizBtn.addEventListener("click", () => {
    ...
    blocks.forEach((block, i) => {
        ...
        quiz.push({
            ...
            correct: answer ? answer.value === "true" : null
        });
    });

    console.log("Invio quiz al peer:", quiz);
    sendQuizToPeer(quiz);
    alert("Quiz inviato!");
...
function showQuestion(index) {
    ...
    receivedText.textContent = question.question;
    ...
    ["true", "false"].forEach(value => {
        ...
        btn.addEventListener("click", () => {
            ...
            const correct = receivedContainer.dataset.correct === "true";
...
// ==================== RICEZIONE QUIZ ====================
window.addEventListener("quiz_received", (event) => {
...
window.addEventListener("quiz_answer", (event) => {
    ...
    console.log("Risposta ricevuta dal peer:", answer);
